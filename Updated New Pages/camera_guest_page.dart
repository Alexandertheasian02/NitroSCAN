...
import 'package:nitroscan_app/result_guest_page.dart';

class CameraGuestPage extends StatelessWidget {
  const CameraGuestPage({super.key});
                ...
                child: Center(
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ResultGuestPage(capturedImage: capturedImage)),
                      );
                    },
